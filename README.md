...
![GNU license logo](png/gplv3-127x51.png)<br/>
Unless otherwise specified:

- All documentation in this GitHub organization is licensed under a [Creative Commons Attribution-ShareAlike 4.0 International License](http://creativecommons.org/licenses/by-sa/4.0/).
- All software in this GitHub organization is licensed under [version 3 of the GNU General Public License (GNU GPLv3)](https://www.gnu.org/licenses/gpl.html).
